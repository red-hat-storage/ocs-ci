...
class PerfResult:
    ...
    def __init__(self, uuid, crd):
        ...
        self.new_index = None  # place holder for the ES full results index name
        self.all_results = {}
        self.es = None  # place holder for the elasticsearch connection
    ...
    def es_write(self):
        ...
        try:
            ...
            log.error(f'Failed writeing data with {e}')
            raise
