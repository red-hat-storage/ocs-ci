...
from ocs_ci.framework.utils import init_ocsci_conf
from ocs_ci.utility.utils import create_directory_path, ocsci_log_path
...
def main(argv=None):
    ...
    for i in range(framework.config.nclusters):
        ...
        create_directory_path(framework.config.RUN["log_dir"])
    arguments.extend(
        [
            "-p",
