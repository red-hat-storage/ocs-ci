...
def noobaa_db_backup_and_recovery(snapshot_factory):
    """
    ...
    restored_noobaa_pvc_obj = pvc.get_pvc_objs(pvc_names=[f"{snap_obj.name}-restore"])
    ...
    logger.info("Changed the parameter persistentVolumeReclaimPolicy to Delete again")
