...
def create_vector_bucket(s3_obj, vector_bucket_name, **kwargs):
    """
    Create a new S3 vector bucket

    Args:
        s3_obj (obj): MCG object with s3vectors_client
    ...
    return s3_obj.s3vectors_client.create_vector_bucket(**params)


def delete_vector_bucket(s3_obj, vector_bucket_name):
    """
    ...
    """
    return s3_obj.s3vectors_client.delete_vector_bucket(
        vectorBucketName=vector_bucket_name
    )


def get_vector_bucket(s3_obj, vector_bucket_name):
    """
    ...
    """
    return s3_obj.s3vectors_client.get_vector_bucket(
        vectorBucketName=vector_bucket_name
    )


def list_vector_buckets(s3_obj, **kwargs):
    """
    ...
    """
    return s3_obj.s3vectors_client.list_vector_buckets(**kwargs)


def create_index(s3_obj, index_name, data_type, dimension, distance_metric, **kwargs):
    """
    ...
    params.update(kwargs)
    return s3_obj.s3vectors_client.create_index(**params)


def delete_index(s3_obj, **kwargs):
    """
    ...
    """
    return s3_obj.s3vectors_client.delete_index(**kwargs)


def get_index(s3_obj, **kwargs):
    """
    ...
    """
    return s3_obj.s3vectors_client.get_index(**kwargs)


def list_indexes(s3_obj, **kwargs):
    """
    ...
    """
    return s3_obj.s3vectors_client.list_indexes(**kwargs)


def put_vectors(s3_obj, vectors, **kwargs):
    """
    ...
    params.update(kwargs)
    return s3_obj.s3vectors_client.put_vectors(**params)


def get_vectors(s3_obj, keys, **kwargs):
    """
    ...
    params = {"keys": keys}
    params.update(kwargs)
    return s3_obj.s3vectors_client.get_vectors(**params)


def delete_vectors(s3_obj, keys, **kwargs):
    """
    ...
    params = {"keys": keys}
    params.update(kwargs)
    return s3_obj.s3vectors_client.delete_vectors(**params)


def list_vectors(s3_obj, **kwargs):
    """
    ...
    """
    return s3_obj.s3vectors_client.list_vectors(**kwargs)


def query_vectors(s3_obj, query_vector, top_k, **kwargs):
    """
    ...
    params.update(kwargs)
    return s3_obj.s3vectors_client.query_vectors(**params)


def delete_all_vectors(s3_obj, **kwargs):
    """
    ...
    while True:
        ...
        response = list_vectors(s3_obj, **list_params)
    ...
    for i in range(0, len(all_vectors), batch_size):
        ...
        delete_vectors(s3_obj, batch_keys, **kwargs)
        deleted_count += len(batch_keys)

    return deleted_count


def put_vector_bucket_policy(s3_obj, vector_bucket_name, policy):
    """
    ...
    """
    return s3_obj.s3vectors_client.put_vector_bucket_policy(
        vectorBucketName=vector_bucket_name, policy=policy
    )


def get_vector_bucket_policy(s3_obj, vector_bucket_name):
    """
    ...
    """
    return s3_obj.s3vectors_client.get_vector_bucket_policy(
        vectorBucketName=vector_bucket_name
    )


def delete_vector_bucket_policy(s3_obj, vector_bucket_name):
    """
    ...
    """
    return s3_obj.s3vectors_client.delete_vector_bucket_policy(
        vectorBucketName=vector_bucket_name
    )
