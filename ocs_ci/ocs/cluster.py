...
def check_cephcluster_status(
    ...
    Args:
        desired_phase (str): The cephcluster desired phase.
        desired_health (str): The cephcluster desired health.
        name (str): name of the cephcluster.
        namespace (str): namespace of the cephcluster.
