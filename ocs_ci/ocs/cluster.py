...
class CephCluster(object):
    ...
    def scan_cluster(self):
        ...
        self.rbdplugins = pod.get_plugin_pods(constants.CEPHBLOCKPOOL, self.namespace)
        self.cephfsplugins = pod.get_plugin_pods(constants.CEPHFILESYSTEM, self.namespace)
    ...
    def mds_health_check(self, count):
        ...
        Raises:
            MDSCountException: if pod count doesn't match
        """
        timeout = 10 * len(self.pods)
