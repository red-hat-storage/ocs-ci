...
class OCP(object):
    ...
    def patch(self, resource_name="", params=None, subresource=None, format_type=""):
        """
        ...
        Args:
            ...
            subresource (str): Used to edit 'status' or 'scale' subresources
        ...
        if subresource:
            command += f" --subresource {subresource}"
        if format_type:
