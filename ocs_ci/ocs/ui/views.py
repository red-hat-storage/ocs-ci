...
bucket_tab = {
    ...
    "submit_button_s3": (
        ...
        "//button[@data-test='obc-create' and @type='submit']",
        By.XPATH,
    ),
    "submit_button_obc": (
...
s3_vector_tab = {
    ...
    "vector_bucket_list_items": (
        "//a[starts-with(@href, '/odf/object-storage/vector-buckets/')] | "
        "//a[contains(@class, 'vector-bucket')]",
        By.XPATH,
    ),
    ...
    "data_type_float32": (
        "//input[@id='data-type-float32' or @data-test='data-type-float32']",
        By.XPATH,
    ),
