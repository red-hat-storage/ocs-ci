...
def format_locator(locator, *args, **kwargs):
    ...
    Args:
        ...
        **kwargs (str): Name–value pair where the name corresponds to the dynamic placeholder
            in the locator and the value contains the web element text to be formatted.
