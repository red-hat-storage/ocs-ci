...
DR_DATA_INTEGRITY_CHECK_SCRIPT = "$DATA_INTEGRITY_CHECK_SCRIPT"
DR_WORKLOAD_POD_LABEL_ID = "workloadpattern"
DR_WORKLOAD_NAMESPACE_LABEL_ID = "rdrworkload"
DR_TP_EXECUTOR_WORKERS = 10
DR_WORKLOAD_PASS = 0
DR_WORKLOAD_FAIL = 1
