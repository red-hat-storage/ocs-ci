...
PLACEMENT_SUBSCRIPTION_PATH = os.path.join(TEMPLATE_DIR, "DR", "placement_subscription.yaml")
MANAGEDCLUSTER_SETBINDING_PATH = os.path.join(TEMPLATE_DIR, "DR", "managedcluster_setbinding.yaml")
CHANNEL_PATH = os.path.join(TEMPLATE_DIR, "DR", "channel.yaml")
SUBSCRIPTION_APP_PATH = os.path.join(TEMPLATE_DIR, "DR", "app.yaml")
SUBSCRIPTION_WORKLOAD_TEMPLATE_PATH = os.path.join(TEMPLATE_DIR, "DR", "subscription.yaml")
SUBSCRIPTION_NAMESPACE_TEMPLATE_PATH = os.path.join(TEMPLATE_DIR, "DR", "namespace.yaml")
