...
VAULT_CA_CERT_PEM = os.path.join(DATA_DIR, "fullchain.pem")
VAULT_CLIENT_CERT_PEM = os.path.join(DATA_DIR, "cert.pem")
VAULT_PRIVKEY_PEM = os.path.join(DATA_DIR, "privkey.pem")
