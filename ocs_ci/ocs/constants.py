...
# NFS
NFS_NAMESPACE_NAME = "openshift-nfs-storage"
NFS_TEMPLATE_DIR = os.path.join(TEMPLATE_DIR, "nfs")
NFS_SA_YAML_DIR = os.path.join(TEMPLATE_DIR, "nfs_sa.yaml")
NFS_CLUSTER_ROLE_YAML_DIR = os.path.join(TEMPLATE_DIR, "cluster-role.yaml")
NFS_CLUSTER_ROLE_BINDING_YAML_DIR = os.path.join(
    TEMPLATE_DIR, "cluster-role-binding.yaml"
)
NFS_ROLE_YAML_DIR = os.path.join(TEMPLATE_DIR, "role.yaml")
NFS_ROLE_BINDING_YAML_DIR = os.path.join(TEMPLATE_DIR, "role-binding.yaml")
