xpath_pvc_page = {
    "Storage Tab": "/html/body/div[2]/div/div/div/div/div[1]/div/div/nav/ul/li[5]/button",
    "PVC Page": "//*[@id='page-sidebar']/div/nav/ul/li[5]/section/ul/li[2]/a",
    "PVC Project Selector": "//*[@id='content']/div[2]/div/div/div/button",
    "PVC Select Project openshift-storage": "//*[@id='openshift-storage-link']",
    ...
    "PVC Label Selector": "//*[@id='content-scrollable']/div/form/div[1]/div[5]/div/label/input",
