...
from ocs_ci.utility.utils import (
    ...
    load_config_file,
    run_cmd, get_ocs_version_from_image,
)
...
def verify_image_versions(old_images, upgrade_version):
    ...
    noobaa_pods = 2 if upgrade_version < parse_version('4.3') else 3
    verify_pods_upgraded(
        old_images, selector=constants.NOOBAA_APP_LABEL, count=noobaa_pods
    )
    verify_pods_upgraded(
...
def get_upgrade_version(ocs_registry_image, version_before_upgrade):
...
def run_ocs_upgrade(ocs_registry_image,
