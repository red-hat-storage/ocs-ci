...
class ClusterLoad:
    ...
    def __init__(
        self, prometheus_token, project_factory=None, pvc_factory=None, sa_factory=None,
        ...
        Args:
            prometheus_token (str): Token used for Prometheus API communication
        ...
        """
        self.prometheus_api = PrometheusAPI(prometheus_token)
