...
def get_operator_generated_device_classes():
    ...
    and are not explicitly defined in the StorageCluster.
...
def verify_device_class_in_osd_tree(
    ...
    Skips OSDs whose device class is operator-generated (arbiter/zone
    classes like europe-west1-b, or non-resilient pool classes like
    rack0) since those are not defined in the StorageCluster.
