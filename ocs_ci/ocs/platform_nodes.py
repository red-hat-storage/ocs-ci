...
class VSPHEREUPINode(VMWareNodes):
    ...
    def add_nodes_with_terraform(self):
        ...
        self.terraform.apply(self.terraform_var, module=constants.COMPUTE_MODULE, refresh=False)
        self.terraform.apply(self.terraform_var, module=constants.COMPUTE_MODULE_VM, refresh=False)
