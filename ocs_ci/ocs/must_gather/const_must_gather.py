...
GATHER_COMMANDS_VERSION = {
    ...
    ('CEPH', 4.7): GATHER_COMMANDS_CEPH + GATHER_COMMANDS_CEPH_4_7,
    ('JSON', 4.7): GATHER_COMMANDS_JSON + GATHER_COMMANDS_JSON_4_7,
    ('OTHERS', 4.7): GATHER_COMMANDS_OTHERS + GATHER_COMMANDS_OTHERS_4_7,
}
