...
class NodeScenarios:
    ...
    def openstack_node_scenarios(
        ...
        """Generates OpenStack node scenarios YAML.
        ...
        if scenarios is None:
            scenarios = [
                {
                    "actions": [NodeScenarios.ACTION_NODE_STOP_START],
                    "cloud_type": NodeScenarios.CLOUD_OPENSTACK,
                    "label_selector": label_selector,
                    "instance_count": instance_count,
                    "timeout": timeout,
                    "duration": duration,
    ...
    def alibaba_node_scenarios(
        ...
        """Generates Alibaba Cloud node scenarios YAML.
        ...
        if scenarios is None:
            scenarios = [
                {
                    "actions": [NodeScenarios.ACTION_NODE_STOP_START],
                    "cloud_type": NodeScenarios.CLOUD_ALIBABA,
                    "label_selector": label_selector,
                    "instance_count": instance_count,
                    "timeout": timeout,
                    "duration": duration,
