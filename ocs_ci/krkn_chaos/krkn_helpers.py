...
class PodScenarioHelper(BaseScenarioHelper):
    ...
    def create_pod_kill_scenarios(self, kill_count, recovery_time=120):
        """Create pod kill scenarios with specified kill count.

        Args:
            kill_count (int): Number of pods to kill
            recovery_time (int): Recovery time in seconds (default: 120)
    ...
    def create_multiple_pod_kill_scenarios(self, kill_counts, recovery_time=120):
