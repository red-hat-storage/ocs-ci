...
class VSPHEREUPI(VSPHEREBASE):
    ...
    class OCPDeployment(BaseOCPDeployment):
        ...
        def patch_nodes_missing_provider_id(self):
            """
            Patch providerID on nodes that are missing it and remove
            ...
            resource pool), patches any nodes missing their ``providerID``,
            and removes the uninitialized taint from those nodes.
            """
            vsphere = VSPHERE(
                config.ENV_DATA["vsphere_server"],
                config.ENV_DATA["vsphere_user"],
            ...
            # Build a map of node name -> node for nodes missing providerID
        ...
        def deploy(self, log_cli_level="DEBUG"):
            ...
            if not config.ENV_DATA["sno"]:
                ...
                self.patch_nodes_missing_provider_id()
