...
def clear_ceph_bluestore_signature_on_wnodes(wnodes, namespace="default"):
    """
...
def install_minimal_ceph_cluster(wnode, namespace="default"):
    ...
    logger.info(
        f"Running install minimal ceph cluster script on the worker node {wnode}"
    )
...
def install_minimal_ceph_conf(wnode, host_node, namespace="default"):
    ...
    logger.info(
        f"Running install minimal ceph conf script on the worker node {wnode} "
...
def install_minimal_ceph_cluster_and_conf_on_wnodes(wnodes, namespace="default"):
    """
