...
class MetalLBInstaller:
    ...
    def deploy_lb(self):
        ...
        if self.apply_icsp():
            logger.info("ICSP brew-regestry applied successfully")
    ...
    def icsp_brew_regestry_exists(self):
        """
    ...
    def apply_icsp(self):
        ...
        """
        if self.icsp_brew_regestry_exists():
        ...
        return self.icsp_brew_regestry_exists()
