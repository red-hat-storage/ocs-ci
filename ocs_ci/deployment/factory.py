...
class DeploymentFactory(object):
    ...
    def __init__(self):
        ...
        if self.deployment_platform == constants.AWS_PLATFORM:
            ...
            from .tnf import TNFOCPDeployment, TNFDeployment
            ...
            self.cls_map.update(
                {
                    ...
                    "baremetal_tnf": TNFOCPDeployment,
                    "baremetal_tnf_odf": TNFDeployment,
                }
            )
            ...
            from .ibm_hci import IBM_HCI_IPI

            self.cls_map["ibm_hci_ipi"] = IBM_HCI_IPI
