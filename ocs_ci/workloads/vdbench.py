...
class VdbenchWorkload:
    ...
    def _render_templates(self):
        ...
        try:
            ...
            # Render deployment template using Jinja2
            try:
                ...
                # Fallback to inline template if Jinja2 template not found
                deployment_yaml = self._create_deployment_template(template_data)
                with open(self.output_file, "w") as f:
                    f.write(deployment_yaml)

            # Render ConfigMap template using Jinja2
            try:
    ...
    def _create_deployment_template(self, data):
        ...
        # Render the deployment template with provided data
    ...
    def _create_configmap_template(self, data):
        ...
        # Render the ConfigMap template with provided data
