...
def osd_scenario1(osd, devices_dict, dmcrypt=False):
    ...
    scenario = (
        ...
        vg_name=vgname, datalv1=data_lv1, datalv2=data_lv2, dblv1=db_lv1,
...
def osd_scenario3(osd, devices_dict, dmcrypt=False):
    ...
    scenario = (
        ...
        "'wal_vg':'{vgname}'}}," "{{'data':'{datalv1}','data_vg':'{vgname}',"
        "'db':'{vdd2}','wal':'{vdd3}'}},{{'data':'{vdd1}'}}"
    ).format(
        vdb=devices_dict.get('device1'), dblv1=db_lv1, vgname=vgname, wallv1=wal_lv1,
        datalv1=data_lv1, vdd1=devices_dict.get('device3') + '1',
        vdd2=devices_dict.get('device3') + '2', vdd3=devices_dict.get('device3') + '3'
    )
