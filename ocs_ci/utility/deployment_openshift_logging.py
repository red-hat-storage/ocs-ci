...
def install_logging():
    ...
    if ocp_version <= version.VERSION_4_7:
        logging_channel = ocp_version
    elif version.VERSION_4_7 < ocp_version <= version.VERSION_4_17:
        logging_channel = "stable"
    else:
        logging_channel = "logging-5.8"
