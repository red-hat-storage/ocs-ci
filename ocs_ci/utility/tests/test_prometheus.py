...
def test_check_query_range_result_single_error(query_range_result_single_error):
    ...
    result1 = check_query_range_result_enum(
        query_range_result_single_error, good_values=[1]
    )
    assert not result1
    result2 = check_query_range_result_enum(
        query_range_result_single_error, good_values=[1, 0]
    )
...
def test_check_query_range_result_exp_metric_num(query_range_result_ok):
    ...
    """
    result1 = check_query_range_result_enum(
        query_range_result_ok, good_values=[1], exp_metric_num=2
    )
    assert result1, "check should pass when exp_metric_num matches the data"
    result2 = check_query_range_result_enum(
        query_range_result_ok, good_values=[1], exp_metric_num=3
    )
...
def test_check_query_range_result_exp_delay(query_range_result_delay_60s):
    ...
    """
    result1 = check_query_range_result_enum(
        query_range_result_delay_60s, good_values=[1], bad_values=[0]
    )
    assert not result1, "without specifying exp_delay validation should fail"
    result2 = check_query_range_result_enum(
        query_range_result_delay_60s, good_values=[1], bad_values=[0], exp_delay=60
    )
...
def test_check_query_range_result_exp_good_time(query_range_result_bad_last_90s):
    ...
    """
    result1 = check_query_range_result_enum(
        query_range_result_bad_last_90s, good_values=[1], bad_values=[0]
    )
