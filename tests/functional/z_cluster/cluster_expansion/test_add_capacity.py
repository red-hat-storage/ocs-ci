...
class TestAddCapacityStretchCluster:
    ...
    def add_capacity_to_stretch_cluster():
        ...
        zone1_osd_weight = tools_pod.exec_ceph_cmd(
            ceph_cmd=f"osd tree | grep 'zone {constants.DATA_ZONE_LABELS[0]}",
            format=None,
            out_yaml_format=False,
        )
        zone2_osd_weight = tools_pod.exec_ceph_cmd(
            ceph_cmd=f"osd tree | grep 'zone {constants.DATA_ZONE_LABELS[1]}",
            format=None,
            out_yaml_format=False,
        )

        assert int(zone1_osd_weight) == int(
            zone2_osd_weight
    ...
    def test_repeated_cluster_expansion(
        self,
        ...
        # generate 2 minutes worth of logs
