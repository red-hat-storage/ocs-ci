"""
FDF Standalone — MCG (NooBaa) Operator Crash Recovery (RHSTOR-8290 / OCS-8193).

Delete NooBaa operator pod and verify it restarts,
NooBaa health returns OK, and workload I/O is uninterrupted.
"""
...
class TestFDFSelfHealMCGOperator:
    """
    Verify MCG (NooBaa) operator self-heals from pod crash on FDF standalone.
    """
    ...
    def test_mcg_operator_crash_recovery(self):
        """
        Delete NooBaa operator pod and verify:
        ...
        logger.info("Deleting NooBaa operator pod")
        ...
        logger.info("Waiting for NooBaa operator pod to restart")
        wait_for_pods_to_be_running(
        ...
        ), "FIO produced no I/O during MCG operator restart"
        logger.info("MCG operator crash recovery verified")
