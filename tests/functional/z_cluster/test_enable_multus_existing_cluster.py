...
class TestEnableMultusExistingCluster(ManageTest):
    ...
    def test_enable_multus_on_existing_cluster(self, pvc_factory, pod_factory):
        ...
        3. Install NMState operator and configure interfaces on compute nodes
        ...
        7. Verify Multus networking is configured on pods
        ...
        logger.info("Step 4: Installing NMState for vSphere platform")
        ...
        logger.info("Step 9: Creating RBD and CephFS PVCs with pods")
