...
class TestCreateScalePodsAndPvcsUsingKubeJobWithHCIClients(ManageTest):
    ...
    def test_create_scale_pods_and_pvcs_with_storage_client_clusters(
        self, create_scale_pods_and_pvcs_using_kube_job_on_storage_client_clusters
    ):
        """
        Test create scale pods and PVCs using a kube job with HCI clients
        """
    ...
    def test_create_and_delete_scale_pods_and_pvcs_with_storage_client_clusters(
        self, create_scale_pods_and_pvcs_using_kube_job_on_storage_client_clusters
    ):
        """
