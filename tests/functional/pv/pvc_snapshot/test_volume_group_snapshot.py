...
@skipif_ocp_version("<4.18")
@pytest.mark.parametrize(
    argnames=["interface"],
    argvalues=[
        pytest.param(constants.CEPHFILESYSTEM, marks=pytest.mark.polarion_id("OCS-6301")),
        pytest.param(constants.CEPHBLOCKPOOL, marks=pytest.mark.polarion_id("OCS-6302")),
        pytest.param(
            constants.NFS_STORAGECLASS_NAME,
            marks=pytest.mark.polarion_id("OCS-6303"),
        ),
    ],
)
