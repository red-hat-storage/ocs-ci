...
class TestNoobaaRouteAuthentication:
    ...
    def test_mgmt_and_endpoint_route_authentication(self):
        ...
        noobaa_metrics_auth_enabled = noobaa_configmap.get()["data"][
            "NOOBAA_METRICS_AUTH_ENABLED"
        ]
        assert (
            noobaa_metrics_auth_enabled == "true"
        ), f"incorrect default value of NOOBAA_METRICS_AUTH_ENABLED. Received value {noobaa_metrics_auth_enabled}"

        noobaa_version_auth_enabled = noobaa_configmap.get()["data"][
            "NOOBAA_VERSION_AUTH_ENABLED"
        ]
        assert (
            noobaa_version_auth_enabled == "true"
        ), f"Incorrect default value of NOOBAA_VERSION_AUTH_ENABLED. Received value {noobaa_version_auth_enabled}"
