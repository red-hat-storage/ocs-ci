...
from ocs_ci.framework.pytest_customization.marks import tier2, turquoise_squad
...
class TestCnvApplicationRDR:
    ...
    def test_cnv_app_failover_and_relocate(
        ...
        """
        Tests to verify CNV based application (Subscription and ApplicationSet) deployment and
