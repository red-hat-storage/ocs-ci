...
class TestCnvApplicationMDR:
    ...
    def test_app_cnv_failover_relocate(
        ...
        """
        Tests to verify CNV based AppSet(Push and Pull based)
        application deployment and fail-over/relocate between managed clusters.
        ...
        # Create CNV applications(appset push+pull)
