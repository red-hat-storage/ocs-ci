...
from ocs_ci.ocs.cluster import (
    is_storage_client_cluster_cluster,
...
class TestHCIProviderClientMarkers(ManageTest):
    ...
    @skipif_storage_client_cluster
    def test_marker_skipif_storage_client_cluster(self):
        """
        Test that the 'skipif_storage_client_cluster' marker work as expected
        """
        assert (
            not is_storage_client_cluster_cluster()
        ), "The cluster is a HCI Client cluster, even though we have the marker 'skipif_storage_client_cluster'"
