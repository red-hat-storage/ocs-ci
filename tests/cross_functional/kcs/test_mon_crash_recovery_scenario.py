...
class TestMonCrashRecoveryScenario:
    ...
    def test_mon_crash_recovery_scenario(self, pod_factory, request):
        ...
        Steps:
            ...
            6. Archive all ceph crashes using 'ceph crash archive-all' command and wait 20 seconds.
        ...
        # Step 7: Archive all ceph crashes
        ...
        # Step 8: Verify 'ceph mon dump' output has the recovered mon information.
        log.info(
        ...
        # Step 9: Check If any crash has generated.
