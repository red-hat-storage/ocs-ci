...
class TestKrKnContainerChaosScenarios:
    ...
    def test_krkn_container_kill_signals_chaos(
        ...
        # 🏗️ WORKLOAD SETUP
        log.info(f"🏗️ Setting up workloads for unified {kill_signal} testing...")
        ...
        try:
            ...
            # =================================================================
            log.info(
                f"⚙️ Creating UNIFIED Krkn configuration with {kill_signal} signal..."
            )
        ...
        # =================================================================
        log.info(
            f"📊 MULTI-COMPONENT CHAOS RESULTS ANALYSIS ({kill_signal}):" + "=" * 60
        )
    ...
    def test_krkn_random_pod_kill(
        ...
        # 🏗️ WORKLOAD SETUP
        log.info("🏗️ Setting up workloads for pod kill testing...")
        workload_ops.setup_workloads()
        ...
        try:
            ...
            # =================================================================
            log.info(
                f"⚙️ Creating pod kill configuration for {stress_level} level: Target namespace: openshift-storage,"
            ...
            scenario_file = pod_helper.create_pod_kill_scenarios(
                kill_count=kill_count, recovery_time=120
            )
        ...
        # RESULTS ANALYSIS
        # =================================================================
        log.info("📊 RANDOM POD KILL CHAOS RESULTS ANALYSIS:" + "=" * 60)
