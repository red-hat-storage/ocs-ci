...
class TestKrKnHogChaosScenarios:
    ...
    def test_krkn_hog_multi_stress_chaos(
        ...
        # 🏗️ WORKLOAD SETUP
        log.info("🏗️ Setting up VDBENCH workloads for multi-stress testing...")
        workload_ops.setup_vdbench_workloads()
        ...
        try:
            ...
            # =================================================================
            log.info(
                "⚙️ Creating UNIFIED Krkn configuration with multiple resource stress levels..."
            )
            ...
            basic_memory = hog_helper.create_memory_hog_scenario(
                duration=basic_duration, namespace="default"
            )
        ...
        # =================================================================
        log.info("📊 MULTI-STRESS HOG CHAOS RESULTS ANALYSIS:")
        log.info("=" * 60)
    ...
    def test_krkn_extreme_cluster_strength_testing(
        ...
        # 🏗️ WORKLOAD SETUP
        log.info("🏗️ Setting up VDBENCH workloads for extreme testing...")
        workload_ops.setup_vdbench_workloads()
        ...
        try:
            ...
            # =================================================================
            log.info(
                f"⚙️ Creating UNIFIED Krkn configuration with {stress_level.upper()} stress levels..."
            )
            ...
            # =================================================================
            log.info(
                f"🚀 EXECUTING unified {stress_level.upper()} chaos configuration..."
            )
            ...
            # =================================================================
            log.info(
                f"📊 {stress_level.upper()} CLUSTER STRENGTH TESTING RESULTS ANALYSIS:"
            )
        log.info("=" * 60)
