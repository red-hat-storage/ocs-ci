...
class TestKeyRotationWithClusterFull(E2ETest):
    ...
    def test_cluster_wide_encryption_key_rotation(
        ...
        self.verify_key_rotation_time(schedule=schedule)
        logger.info("Verifying new key generation after cluster full")
        verify_new_key_after_rotation(tries, delays)
        ...
        logger.info("Validating NooBaa DB backup and recovery")
        validate_noobaa_db_backup_recovery_locally_system(
            bucket_factory_session,
            noobaa_db_backup_and_recovery_locally,
            warps3,
        ...
        logger.info("NooBaa DB backup and recovery validation completed")
        ...
        logger.info("Test execution completed for cluster-wide encryption key rotation")
    ...
    def verify_key_rotation_time(self, schedule):
        ...
        try:
            ...
            logger.info("All key rotation schedules validated successfully.")
