...
class TestRbdSpaceReclaim(ManageTest):
    ...
    @tier2
    def test_space_reclaim_multiple_pvc_without_io(self, pause_and_resume_cluster_load):
        """
    ...
    @tier2
    def test_space_reclaim_multiple_pvc_with_io(self, pause_and_resume_cluster_load):
        """
        ...
        # Delete the file from all the pods
        self.delete_file_from_the_pods(self.pod, fio_filename1)
