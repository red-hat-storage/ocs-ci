...
class TestSnapshotRestoreWithDifferentAccessMode(ManageTest):
    ...
    def test_snapshot_restore_with_different_access_mode(
        ...
        log.info(
            ...
            "Wait for the snapshots to be in Ready state"
        )
        ...
        for snap_obj in snap_objs:
            ...
            for access_mode in access_modes:
                restore_obj = snapshot_restore_factory(
                    ...
                    access_mode=access_mode, status=''
                )
        ...
        log.info(
            "Restored all the snapshots to create PVCs with different "
            "access modes"
        )
        ...
        for pvc_obj in restore_pvcs:
            assert pvc_obj.data['spec']['volumeMode'] == pvc_obj.snapshot.parent_volume_mode, (
        ...
        for pod_obj in restore_pod_objs:
            ...
            pod.verify_data_integrity(
                pod_obj, file_name_pod, pod_obj.pvc.md5sum,
