    ...
    def test_clone_with_different_access_mode(
        ...
        access_modes_dict = {
            constants.CEPHBLOCKPOOL: {
                ...
                constants.VOLUME_MODE_BLOCK: [
                    constants.ACCESS_MODE_RWX, constants.ACCESS_MODE_RWO
                ]
            },
        ...
        for pod_obj in self.pods:
            ...
            pod_obj.run_io(
                ...
                runtime=20, fio_filename=file_name, end_fsync=1
            )
        ...
        for pvc_obj in cloned_pvcs:
            ...
            for _ in range(
                int(pvc_obj.get_pvc_access_mode != constants.ACCESS_MODE_RWX),
                2
            ):
                clone_pod_obj = pod_factory(
                    interface=pvc_obj.interface, pvc=pvc_obj, status='',
                    node_name=next(nodes_iter), pod_dict_path=pod_dict_path,
