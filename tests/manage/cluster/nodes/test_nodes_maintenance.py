...
class TestNodesMaintenance(ManageTest):
    ...
    def test_node_maintenance(self, node_type, pvc_factory, dc_pod_factory):
        """
        OCS-1269/OCS-1272:
    ...
    def test_node_maintenance_restart_activate(
        self, ec2_instances, aws_obj, pvc_factory, dc_pod_factory, node_type
    ):
        """
        OCS-1292/OCS-1293:
        - Maintenance (mark as unscheduable and drain) 1 worker/master node
    ...
    def test_2_nodes_maintenance_same_type(
        self, pvc_factory, dc_pod_factory, nodes_type
    ):
        """
        OCS-1273/OCs-1271:
    ...
    def test_2_nodes_different_types(self, pvc_factory, dc_pod_factory):
        """
        OCS-1274:
