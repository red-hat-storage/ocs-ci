...
class TestNodesMaintenance(ManageTest):
    ...
    def test_node_maintenance(self, node_type, pod_factory):
        """
        OCS-1269/OCS-1272:
    ...
    def test_2_nodes_maintenance_same_type(
        self, pvc_factory, pod_factory, schedule_nodes, nodes_type
    ):
        """
        OCS-1273/OCs-1271:
    ...
    def test_2_nodes_different_types(self, pvc_factory, pod_factory, schedule_nodes):
        """
        OCS-1274:
