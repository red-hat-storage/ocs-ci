...
class TestCheckStorageClassDetailByOcDescribe(ManageTest):
    """
    Test class for storageclass detail check by oc describe
    """
    def test_check_storageclass_detail_by_oc_describe_RBD(self):
        """
        ...
        if len(value) == 1 and value['volumeBindingMode'] == 'Immediate':
            ...
            assert ("OC describe sc output didn't matches storage class yaml")

    def test_check_storageclass_detail_by_oc_describe_CEPHFS(self):
        """
