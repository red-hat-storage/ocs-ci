...
@tier4a
@bugzilla('1847098')
class TestAddCapacityWithRookOperatorPodDelete(ManageTest):
    """
    Test add capacity when rook operator pod gets deleted
    in the middle of the process.
    """

    def test_add_capacity_rook_operator_pod_delete(self, workload_storageutilization_rbd):
        """
        Test add capacity when rook operator pod gets deleted
        in the middle of the process.
        """
        ...
        logging.info("Delete a rook operator pod while storage capacity is getting increased")
        d.delete_resource(0)
