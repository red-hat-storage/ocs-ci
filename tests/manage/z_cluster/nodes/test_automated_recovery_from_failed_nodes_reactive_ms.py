...
class TestAutomatedRecoveryFromFailedNodeReactiveMS(ManageTest):
    ...
    def verification_steps_after_automated_recovery(
        self,
        pvc_factory,
        pod_factory,
        bucket_factory,
        ...
        """
        Verification steps after the automated recovery. Check that the cluster is in
        a good health, and everything works fine.
    ...
    def test_automated_recovery_from_stopped_node(
        ...
        5) Check that the cluster is in a good health, and everything works fine.
        ...
        self.verification_steps_after_automated_recovery(
            pvc_factory, pod_factory, bucket_factory, rgw_bucket_factory
        )
