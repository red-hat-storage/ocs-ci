...
def wait_to_update_mgrpod_info_prometheus_pod(prometheus_token):
    """
    ...
    assert check_ceph_health_status_metrics_on_prometheus(mgr_pod=mgr_pod, prometheus_token=prometheus_token), (
...
def wait_for_nodes_status_and_prometheus_health_check(pods, prometheus_token):
    """
    ...
    for pod_obj in pods:
        assert check_pvcdata_collected_on_prometheus(pod_obj.pvc.name, prometheus_token), (
...
class TestMonitoringBackedByOCS(E2ETest):
    ...
    @pytest.fixture()
    def pods(self, multi_pvc_factory, dc_pod_factory, prometheus_token):
        """
    ...
    def test_monitoring_after_restarting_prometheus_pod(self, pods, prometheus_token):
        """
    ...
    def test_monitoring_after_draining_node_where_prometheus_hosted(self, pods, prometheus_token):
        """
    ...
    def test_monitoring_after_respinning_ceph_pods(self, pods, prometheus_token):
        """
    ...
    def test_monitoring_when_osd_down(self, pods, prometheus_token):
        """
    ...
    def test_monitoring_when_one_of_the_prometheus_node_down(self, nodes, pods, prometheus_token):
        """
    ...
    def test_monitoring_after_rebooting_master_node(self, nodes, pods, prometheus_token):
        """
        ...
        for node in master_nodes:
            ...
            wait_for_nodes_status_and_prometheus_health_check(pods, prometheus_token)

        # Check the node are Ready state and check cluster is health ok
        self.sanity_helpers.health_check()

    @pytest.mark.polarion_id("OCS-710")
    def test_monitoring_after_rebooting_node_where_mgr_is_running(self, nodes, pods, prometheus_token):
        """
        ...
        wait_to_update_mgrpod_info_prometheus_pod(prometheus_token)
    ...
    @skipif_aws_i3
    def test_monitoring_shutdown_and_recovery_prometheus_node(self, nodes, pods, prometheus_token):
        """
